...
export default function EditPost(){
    ...
    return(
        ...
        <p className="font-bold text-4xl pt-20">Edit Post</p>
        ...
        <form className="bg-blue-100 px-20 py-10 border border-blue-200 rounded-xl ml-44 my-16">
            ...
            <div className="flex flex-wrap -mx-3 mb-2">
                ...
                <button className="bg-amber-500 hover:bg-amber-700 text-white font-bold py-2 px-6 rounded" onClick={e => submitted(e)}>Edit</button>
